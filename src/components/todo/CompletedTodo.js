...
const CompletedTodo = ({el, deleteTask, updateTodo, updateStatus}) => {
        ...
        <li className="list-group-item d-flex justify-content-between align-items-center">

            {
                edit ?  <input type="text"
                    ...
                    <span className={ "text-decoration-line-through" }>{el.title}</span>
            }
            <div className="d-flex">
                <input type="checkbox" checked={el.isCompleted} onChange={() => changeStatus(el.id)}/>
                <button
